...
func (g TxtFileGenerator) Generate(wg *sync.WaitGroup) error {
...
func write(wg *sync.WaitGroup, file *os.File, payload string, size int) error {
	defer wg.Done()
